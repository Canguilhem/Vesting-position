...
export function GradientOutlineBadge({
  ...
  return (
    ...
    >
      <span className="inline-flex items-center rounded-[calc(var(--radius-md)-1px)] bg-background/95 px-2.5 py-1 text-xs font-medium text-foreground backdrop-blur-sm">
        {children}
      </span>
    </span>
  );
